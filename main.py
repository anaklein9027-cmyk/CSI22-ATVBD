...
class Application:
    ...
    #com o CEP retorna o endereço
        ...
        self.treeview = ttk.Treeview(columns=( "ID","Nome", "CPF_CNPJ", "Nascimento", "CEP", "Endereço", "Contato"))


        self.treeview.heading("ID", text="ID")
        self.treeview.heading("Nome", text="Nome")
        self.treeview.heading("CPF_CNPJ", text="CPF_CNPJ")
        self.treeview.heading("Nascimento", text="Nascimento")
    ...
    def listar(self):
        ...
        try:
            ...
            for res in resultados:
                ...
                self.treeview.insert("", 'end', text =f"L{i}", values =(f"{idd}", f"{nome}" ,f"{cpf_cnpj}", f"{nascimento}", f"{CEP}" , f"{endereço}", f"{contato}"))
                i+=1
